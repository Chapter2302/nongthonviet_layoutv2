      ...
      <div class="grid grid-cols-12 gap-4 flex-grow">
        ...
        <div class="col-span-6 xs:col-span-12">
          <div class="flex justify-center items-center">
            ...
            <SlideSwiper :HomeA_Slide="HomeA_Slide"/>
          </div>
        </div>
        <div class="col-span-3 xs:col-span-12">
          <div>
            <Article :post="HomeA_Main[0]" isFull :options="{penName: false, publicationTime: false, image: true,
          title: true,excerpt: false}"/>
          </div>
          <div class="mt-4">
            <ArticleListing2 :posts="HomeA_Main.slice(1,7)"/>
          </div>
        </div>
        <div class="col-span-3 xs:col-span-12" style="height: 100%">
          <AdsBlock adsNameByProp="HomeA_Right" maxHeight="100%" />
        </div>
      </div>
    </div>
